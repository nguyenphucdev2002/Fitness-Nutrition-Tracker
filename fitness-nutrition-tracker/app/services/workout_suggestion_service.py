...
{{
    ...
    "workouts": [
        {{
            "name": "<tên bài tập (nếu là tên tiếng anh thì chú thích thêm tên tiếng việt)>",
            "type": "<cardio|strength|flexibility|bài tập tay không tại nhà>",
...
Lưu ý:
- Mỗi bài tập phải có type là một trong: cardio, strength, flexibility, bài tập tay không tại nhà
...
- Đảm bảo phù hợp với mục tiêu, cân nặng, chiều cao, BMI, mức độ hoạt động, tuổi và giới tính.
- Ví dụ như: người có cân nặng 80kg mục tiêu giảm cân và người có cân nặng 60kg mục tiêu giảm cân thì sẽ có những bài tập khác nhau. Tương tự với các mục tiêu khác.
